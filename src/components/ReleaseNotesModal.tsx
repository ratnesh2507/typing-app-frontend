      ...
      <div className="bg-background p-6 rounded-2xl max-w-md w-full shadow-xl border border-accent">
        ...
        <ul className="list-disc list-inside text-text/90 mb-4">
          ...
          <li>
            ...
            <span className="text-correct font-semibold">Red</span> = correct,{" "}
          ...
          <li>
            📊 Dashboard improvements: real-time WPM, Accuracy, and past races
            auto-sync.
          </li>
        </ul>

        <h3 className="font-semibold text-accent mb-2">⚡ Improvements</h3>
        <ul className="list-disc list-inside text-text/90 mb-4">
          <li>⚡ Faster race progress updates and smoother text rendering.</li>
        ...
        <h3 className="font-semibold text-accent mb-2">🐞 Bug Fixes</h3>
        <ul className="list-disc list-inside text-text/90 mb-4">
